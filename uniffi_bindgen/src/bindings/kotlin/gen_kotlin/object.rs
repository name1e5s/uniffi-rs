...
use crate::interface::{ComponentInterface, DelegateObject, Object, Type};
use askama::Template;
...
pub struct KotlinObject {
    inner: Object,
    delegate_object: Option<DelegateObject>,
}
...
impl KotlinObject {
    ...
    pub fn delegate_object(&self) -> Option<&DelegateObject> {
